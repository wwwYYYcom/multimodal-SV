...
### E30j：Fisher 原始音频全部 16 片一次性生成

- 用户于本轮要求一次性生成剩余切片。第 3–16 片已于 2026-09-01 15:31 +08:00 前全部生成到 `C:\mmsv_transfer`；连同既有第 1、2 片，共 16 个独立 TAR、16 份 `.files.txt`、16 份 `.audit.json` 和 16 份 `.sha256`。分包器的拒绝覆盖检查在批处理开始前确认第 3–16 片均不存在。
- 全量 audit 汇总：5,879 个文件、30,040,328,697 源字节，与 Fisher Part 1 corpus 本机统计完全相同；16 个 TAR 合计 30,044,854,784 字节。随后重新读取全部约 30 GB TAR，对每片执行 `tar -tf`、实际成员数与 audit 交叉核对并重新计算 SHA-256；16/16 均为 `VERIFY_OK`。
- 汇总校验文件：`C:\mmsv_transfer\mmsv_05_fisher_p1_audio_20260901.all.sha256`，1,904 字节，SHA-256 `9c9459ee78828ca5f2e87ee62b66dd8d9ae09a2a3685bfba443dba2cd3ce95b7`。服务器上传各 TAR 后可用该文件执行批量 `sha256sum -c`。

| Part | 文件数 | 源字节 | TAR 字节 | TAR SHA-256 |
|---:|---:|---:|---:|---|
| 1/16 | 329 | 1,895,093,518 | 1,895,350,272 | `6191a3593aa68acb888c8600a600fe559ef6e1ba6be1265ff84e271bd7ad9594` |
| 2/16 | 380 | 1,899,834,340 | 1,900,129,792 | `e629d71a5b725143db2d5f902983fa0486ec53d38484efae002c3130b1cedba2` |
| 3/16 | 378 | 1,897,793,407 | 1,898,081,792 | `bad76ffdf1025417b0ec24ac8c9715d33ac90aa95f5e89c6f07393b6a4536f13` |
| 4/16 | 379 | 1,897,183,851 | 1,897,475,072 | `ebb5d597a0adf44e3124c43faf1373fc97e50ca4bb1de713144df29556af1166` |
| 5/16 | 376 | 1,896,619,565 | 1,896,906,752 | `981a2ab694757e341f8005f9e4a6c82aa81d3c239517b8e9c07709d2d281b666` |
| 6/16 | 372 | 1,898,324,416 | 1,898,607,104 | `7e484672da2ca0017a00beec378263fb6d395ee5d5619c52db61381dd0508432` |
| 7/16 | 367 | 1,897,661,139 | 1,897,945,088 | `8c64f1d9bbb780ed884985f1c4d4421da78578a00cf8a36af597a00fa343c16e` |
| 8/16 | 370 | 1,896,783,875 | 1,897,070,080 | `43d71ba77d33711f43d9c783c079cca0e6d4ffae86cf8b24aaf54a3c840ebf4c` |
| 9/16 | 368 | 1,899,002,608 | 1,899,284,480 | `bf62266e69325491b4f2590a5ee6c9166cfde99e3c9b49880972d7dda12e1fab` |
| 10/16 | 373 | 1,897,331,566 | 1,897,616,896 | `2bc2c3434134a5e649821a1076e08f90d1c3487290f8618da97758b07aef4f6d` |
| 11/16 | 372 | 1,896,841,968 | 1,897,125,376 | `9e8848a222ddbd5c5b4642527e1944cec2bdc30e4d4fa1c75e109fbbe2ee99b9` |
| 12/16 | 379 | 1,899,093,288 | 1,899,385,344 | `1c0ca8d131820d1d7c1874aa39602cf306870632787b3c4b9ee4775760d356e7` |
| 13/16 | 377 | 1,899,112,465 | 1,899,403,776 | `897fc8ec84fd723fd5956a8e71f956d519264b6367cfe51ddad1c5e2aba3b3a4` |
| 14/16 | 377 | 1,899,971,773 | 1,900,262,400 | `9cc71f8507be2cb6133c8930876e7dfb1c0ac6ddb317f8f75769a3058a041fd6` |
| 15/16 | 375 | 1,898,001,724 | 1,898,295,808 | `c38522ee210733944a4e9b741736ba3b33250a24835a5f05349aea2c09677504` |
| 16/16 | 307 | 1,571,679,194 | 1,571,914,752 | `e458bd0382c7e5f3183c2006fc1934b2f3a0fd275fd3f2abb134bad55d2f9a64` |
...
### E30t：为增加 GPU 数量终止 2-GPU 流水线

- 切换边界：2026-09-02 12:58:15 +00:00 的首次记录为 115,101 个 FLAC、6,769,565,469 字节。首次只终止 worker 时，supervisor PID `1519` 按容错设计将退出视为失败并依次重新启动 worker，因此旧流水线未被该次操作实际终止；新 worker PID 一度包括 `29671/29878/30175/30472`。这属于 supervisor 自动恢复机制生效，不是模型故障。
